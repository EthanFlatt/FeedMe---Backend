...
const main = async () => {
    ...
    const dishes = [
        ...
        },
        {
            ...
            instuctions: 'Make the meringue: Beat the egg whites and sugar, then fold in the cornstarch, vanilla, and lemon juice. Bake the meringue: Spoon the meringue onto a prepared baking sheet following the detailed instructions. Bake the meringue until it is dry and sounds hollow when tapped. Make the whipped cream: Beat the heavy cream until stiff peaks form. Assemble the pavlova: Fill the meringue with the whipped cream, then topped with the kiwi slices.',
