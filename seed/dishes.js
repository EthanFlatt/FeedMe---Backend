...
const main = async () => {
    ...
    const dishes = [
        ...
        {
            name: 'jollof rice',
            ingredients: ['onion', 'tomato', 'chicken', 'rice'],
        ...
        },
        {
            ...
            ingredients: ['onion', 'pepper', 'zucchini', 'beans', 'broth', 'ginger'],
        ...
        {
            name: 'hummus',
            ingredients: ['beans', 'olive oil', 'garlic', 'salt'],
            ingredients: 'Blend garbanzo beans, lemon juice, olive oil, garlic, cumin, salt, and sesame oil in a food processor; stream reserved bean liquid into the mixture as it blends until desired consistency is achieved.',
        ...
        {
            name: 'doro wat',
            ingredients: ['butter', 'onion', 'tomato', 'garlic', 'ginger', 'chicken', 'wine', 'pepper', 'eggs'],
        ...
        },
        {
            ...
            ingredients: ['flour', 'sugar', 'salt', 'cocoa', 'eggs'],
        ...
        {
            name: 'dumplings',
            ingedients: ['pork', 'ginger', 'garlic', 'green onion', 'soy sauce', 'cabbage'],
        ...
        {
            name: 'potstickers',
            ingredients: ['shrimp', 'beef', 'ginger', 'shallot', 'green onion', 'cabbage', 'soy sauce', 'salt', 'sugar'],
        ...
        {
            name: 'ramen',
            ingredients: ['chicken', 'scallops', 'shrimp', 'ginger', 'daishi', 'soy sauce', 'sake', 'green onions', 'sugar', 'garlic'],
        ...
        {
            name: 'chili crab',
            ingredients: ['ketchup', 'broth', 'eggs', 'soy sauce', 'garlic', 'oyster sauce', 'tamarind', 'shallot', 'garlic', 'vegetable oil', 'ginger', 'crab', 'cilantro', 'green onion'],
        ...
        {
            name: 'Nasi Goreng',
            ingredients: ['eggs', 'vegetable oil', 'onion', 'leek', 'peppers', 'garlic', 'chicken', 'shrimp', 'coriander', 'cumin', 'rice', 'soy sauce'],
        ...
        {
            name: india,
            ingredients: ['olive oil', 'onion', 'garlic', 'curry powder', 'cinnamon', 'paprika', 'gigner', 'sugar', 'salt', 'chicken', 'tomato', 'yogurt', 'coconut milk', 'cayenne'],
        ...
        {
            name: 'kebab',
            ingredients: ['onion', 'lamb', 'beef', 'salt', 'pepper', 'turmeric', 'eggs'],
        ...
        {
            name: 'beef gyro',
            ingredients: ['yogurt', 'cucumber', 'olive oil', 'dill', 'lemon', 'garlic', 'salt', 'pepper', 'steak', 'pita bread', 'tomato', 'onion', 'feta cheese', 'lettuce', 'olives'],
        ...
        {
            name: 'spaghetti',
            ingredients: ['beef', 'onion', 'garlic', 'pepper', 'tomato', 'oregano', 'basil', 'salt', 'pepper'],
        ...
        {
            name: 'paella',
            ingredients: ['chicken', 'chorizo', 'shrimp', 'rice', 'onion', 'pepper', 'chicken stock', 'saffron', 'red pepper flakes', 'lemon zest', 'oregano', 'paprika', 'salt', 'pepper'],
        ...
        {   
            name: 'fish and chips',
            ingredients: ['potato', 'flour', 'baking powder', 'salt', 'pepper', 'milk', 'eggs', 'vegetable oil', 'cod fillets'],
        ...
        {
            name: 'Poutine',
            ingredients: ['vegetable oil', 'beef gravy', 'potato', 'cheese curds'],
